...
export default class AddRelease extends Component {
    ...
    save(e) {
        ...
        const newRelease = {
            ...
            Date: this.state.release.releaseDate.toDateString(),
        ...
        return (
            <div>
                                    ...
                                    <div className="ui-grid-row">
                                        ...
                                        <div className="ui-grid-col-8" style={{ color: '#7cc67c', padding: '4px 20px 4px 0px', fontSize: '80%', width: '50%', marginLeft: '-3px' }}>
                                            <Calendar id="releaseDate" showIcon="true" dateFormat="dd/mm/yy"
                                                onChange={(e) => { this.updateProperty('releaseDate', e.value) }} value={this.state.release.releaseDate}></Calendar>
                                        </div>
                                    </div>
                ...
                <div style={{ padding: '3px' }} className="ui-g-8">
                    <ShowReleases releaseList={_releaseCollection} />
                </div>
            </div>
        );
    }
